var a = new Array (4);
	...
	if 	 (aa > an ){
		...
		document.getElementById("text").innerHTML = "<span>London</span> will be more affordable than <spa>Amsterdam</span> for the New Years celebration Difference in price";
	}
	else {
